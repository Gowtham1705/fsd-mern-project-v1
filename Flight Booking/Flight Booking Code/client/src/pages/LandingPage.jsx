    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Your trusted partner for seamless travel experiences</h1>
            <p className="banner-p">Booking your next flight has never been easier. Explore a wide range of airlines and find the best fares instantly. With our secure and hassle-free booking system, you can plan your trips with confidence and convenience. Your journey to new destinations starts here</p>     
          </div>
        ...
        <div className="container">
            ...
            <p className="section-description">
                &nbsp; &nbsp;&nbsp; &nbsp; At CANDY FLIGHTS, we are dedicated to making air travel simple and stress-free. Our platform allows you to search, compare, and book flights from hundreds of airlines worldwide. We focus on providing the best fares and real-time availability to help you plan your trips efficiently. Security and convenience are at the core of our service, ensuring every booking is smooth and reliable. Our team strives to offer a user-friendly experience for both frequent travelers and occasional flyers. 
            </p>
            <p className="section-description">
            ...
            <span><h5>2025 CANDY FLIGHTS Connect - &copy; All rights reserved</h5></span>
